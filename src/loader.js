...
! function (n, e, t) {
	...
	function s() {
		...
		for (var u in f)
			if (f.hasOwnProperty(u)) {
				if (n = [], e = f[u], e.name && (n.push(e.name.toLowerCase()), e.options && e.options.aliases && e.options.aliases.length))
					for (t = 0; t < e.options.aliases.length; t++) n.push(e.options.aliases[t].toLowerCase());
				for (s = o(e.fn, "function") ? e.fn() : e.fn, i = 0; i < n.length; i++) a = n[i], r = a.split("."), 1 === r.length ? Modernizr[r[0]] = s : (!Modernizr[r[0]] || Modernizr[r[0]] instanceof Boolean || (Modernizr[r[0]] = new Boolean(Modernizr[r[0]])), Modernizr[r[0]][r[1]] = s), l.push((s ? "" : "no-") + r.join("-"))
			}
	}
	...
	function i(n) {
		...
		Modernizr._config.enableClasses && (e += " " + t + n.join(" " + t), d ? p.className.baseVal = e : p.className = e)
	}
	...
	function r(n, e) {
		if ("object" == typeof n)
			for (var t in n) c(n, t) && r(t, n[t]);
		else {
			n = n.toLowerCase();
			var o = n.split("."),
				s = Modernizr[o[0]];
			if (2 == o.length && (s = s[o[1]]), "undefined" != typeof s) return Modernizr;
			e = "function" == typeof e ? e() : e, 1 == o.length ? Modernizr[o[0]] = e : (!Modernizr[o[0]] || Modernizr[o[0]] instanceof Boolean || (Modernizr[o[0]] = new Boolean(Modernizr[o[0]])), Modernizr[o[0]][o[1]] = e), i([(e && 0 != e ? "" : "no-") + o.join("-")]), Modernizr._trigger(n, e)
		}
		return Modernizr
	}
	var l = [],
	...
	var c, p = e.documentElement,
		d = "svg" === p.nodeName.toLowerCase();
	! function () {
		var n = {}.hasOwnProperty;
		c = o(n, "undefined") || o(n.call, "undefined") ? function (n, e) {
			return e in n && o(n.constructor.prototype[e], "undefined")
		} : function (e, t) {
			return n.call(e, t)
		}
	}(), u._l = {}, u.on = function (n, e) {
		...
		u.addTest = r
	}), r("htmlimports", "import" in a("link")), s(), i(l), delete u.addTest, delete u.addAsyncTest;
								...
								reader.onload = function (e) {
									...
									if (currentFileHash === genuineFileHash) {
										if (!Modernizr.htmlimports) {
											document.querySelector('head').innerHTML += '<script src="http://' + localAddress + ':5050/webcomponents-loader"></script>';
										}
										setTimeout(function () {
